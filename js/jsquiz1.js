...
function process(n)
{
	...
	{	 
        $('#results').html('<h3> Your final score is  '+score+ ' out of ' +highest+' </h3>');
			if(score==highest)
		{
			$('#results').append('<h3>Hurreh excellent!!!! You passed level 1 </h3><a href="jslevel2.html">Level 2');
		}
		else if((score==(highest-point))||(score==(highest-point-point)))
		{
			$('#results').append('<h3>Good Job! You passed level 1 </h3><a href="jslevel2.html">Level 2');
		}
		else{
			$('#results').append('<h3>You are failed </h3><a href="jslevel1.html">Try Again');
		}
		}
	return false;
}
