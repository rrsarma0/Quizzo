...
function process(n)
{
	...
	if(n==total)
	{
        $('#results').html('<h3> Your final score is  '+score+ ' out of ' +highest+' </h3>');
			if(score==highest)
		{
			$('#results').append('<h3>Hurreh excellent!!!! You passed level 1 </h3><a href="level2.html">Level 2');
		}
		else if((score==(highest-point))||(score==(highest-point-point)))
		{
			$('#results').append('<h3>Good Job! You passed level 1 </h3><a href="level2.html">Level 2');
		}
		else{
